# Careers and Skills in Data Analytics
...
These roles all involve working with data, but they focus on different aspects:

### Data Analyst
The most common starting role. You explore data, build reports, and create dashboards to help your team make decisions.

**Day-to-day:** Pull data from databases with SQL. Clean and analyze it in Excel or Python. Build charts and dashboards in Tableau. Present findings to your team.

**Typical salary range (US):** $55,000 - $85,000 for entry-level.

### Business Intelligence (BI) Analyst
Similar to a data analyst but focused on building dashboards and reporting systems that the whole company uses.

**Day-to-day:** Design and maintain Tableau or Power BI dashboards. Write SQL queries to feed those dashboards. Work closely with stakeholders to understand what metrics matter.
...
**Typical salary range (US):** $55,000 - $80,000 for entry-level.

---

## Skills Employers Look For

Based on thousands of data analyst job postings, here are the most requested skills and where this course covers them:

| Skill | How Common in Job Postings | Where You Learn It |
|-------|---------------------------|-------------------|
| Excel | Very common (85%+) | Module 2: Spreadsheets |
| SQL | Very common (85%+) | Module 4: Databases & SQL |
| Python | Common (50-60%) | Modules 3, 5 |
| Tableau / Power BI | Common (40-50%) | Module 5: Visualization |
| Data cleaning | Always expected | Modules 2, 3 |
| Communication | Always expected | Module 5 (dashboards), Module 7 (capstone) |
| Critical thinking | Always expected | Woven throughout every module |
...
3. **Can you explain your work?** Practice describing your analysis in plain English, not jargon.

---

## Building Your Portfolio

As you work through this course, you are building portfolio pieces:

- **Python scripts** that load, clean, and analyze data (Modules 3-4)
- **Charts and visualizations** created with code (Module 5)
- **Tableau dashboards** published to Tableau Public (Module 5)
- **A capstone project** that demonstrates the full analytics workflow (Module 7)

By the end of this course, you will have tangible work to show potential employers.
